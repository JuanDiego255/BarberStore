<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Category List'); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            <div class="media mb-4 float-right">
                <a href="<?php echo e(route('admin.product.category.create')); ?>" class="btn btn-sm btn-primary mr-2">
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $productCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                    ...
                                    <a href="javascript:void(0)"
                                        data-route="<?php echo e(route('admin.product.category.delete', $item->id)); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\barber\resources\views/admin/product_category/list.blade.php ENDPATH**/ ?>