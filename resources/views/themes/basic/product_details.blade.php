                    ...
                    <div class="section_left">
                        <div class="image_area single_product_slider">
                            @forelse ($product_details->slider_image as $img)
                                <img src="{{ getFile(config('location.product.path_slider').$img)}}" alt="...">
                            @empty
                            @endforelse
                        </div>
                ...
                <div class="col-md-6" data-aos="fade-right">
                    <div class="section_right pt-30">
                        ...
                        <div class="section_body">
                            <p class="pt-15 pb-20"> @lang(optional($product_details->details)->description)</p>
                            <div class="mb-30">
                                @foreach($product_details->attribute_details as $key => $attributes)
                                    <div class="size_details d-flex align-items-center mt-4 attribute-length">
                ...
                <div class="tabs_area mt-60">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade  accordion accordionExample" id="profile-tab-pane"
                                            ...
                                            <div class="text_area">
                                                ...
                                                <div class="reply_area mt-30 mb-15 d-flex">
                                                    ...
                                                    <div class="text_area mb-25">
                                                        <h5 class="d-flex justify-content-between reply_text mb-2">
                                                ...
                                                @if(Auth::guard('admin')->check() && $isReplyExists <= 0 )
                                                    <div id="collapse{{$key}}" class="accordion-collapse collapse show"
                                                        ...
                                                        <form action="{{ route('reply',$rate->id) }}" method="post">
                                                            @csrf
                                                            <div class="accordion-body reply_box mb-20">
                                                            ...
                                                            <button type="submit"
                                                                    class="common_btn mb-10">@lang('POST REPLY')</button>
                                                        </form>
                                                    </div>
                                                @endif
                                            </div>
                            ...
                            @if($isRatingExists <= 0)
                                <div class="start_review_area mt-4" data-aos="fade-up">
                                    <div class="section_header">
                                    ...
                                    <form action="{{ route('user.add.review.rating') }}" method="post">
                                        @csrf
                                        <div class="form_area">
                                            <div class="raitng_review d-flex align-items-center mb-1">
