...
<script>
    ...
    root.style.setProperty('--soft_orange', '<?php echo e(config('basic.base_color')??'#df8e6a'); ?>');
    root.style.setProperty('--btn_bg1', '<?php echo e(config('basic.base_color')??'#df8e6a'); ?>');
    root.style.setProperty('--logo_color', '<?php echo e(config('basic.base_color')??'#df8e6a'); ?>');
    root.style.setProperty('--primary', '<?php echo e(config('basic.base_color')??'#df8e6a'); ?>');

</script>
<?php /**PATH C:\xampp\htdocs\barber\resources\views/plugins.blade.php ENDPATH**/ ?>