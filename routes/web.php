...
//        });
        ...
        Route::put('/appointment/date-fixed/{id?}', 'User\MyAppointmentController@myAppointmentDateFixed')->name('my.appointment.date.fixed');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function () {
        ...
        Route::middleware('module:gallery')->group(function () {
            ...
            Route::put('/gallery/items/update/{id?}', 'Admin\ManageGalleryController@galleryItemsUpdate')->name('gallery.items.update');
            Route::delete('/gallery/items/delete/{id}', 'Admin\ManageGalleryController@galleryItemsDelete')->name('gallery.items.delete');
        ...
        Route::middleware('module:blog')->group(function () {
            ...
            Route::get('/blog-category/list', 'Admin\BlogCategoryController@blogCategoryList')->name('blog.category.list');
            Route::get('/blog-category/create', 'Admin\BlogCategoryController@blogCategoryCreate')->name('blog.category.create');
            Route::post('/blog-category/store/{language?}', 'Admin\BlogCategoryController@blogCategoryStore')->name('blog.category.store');
            Route::delete('/blog-category/delete/{id?}', 'Admin\BlogCategoryController@blogCategoryDelete')->name('blog.category.delete');
            Route::get('/blog-category/edit/{id?}', 'Admin\BlogCategoryController@blogCategoryEdit')->name('blog.category.edit');
            Route::put('/blog-category/update/{id?}/{language?}', 'Admin\BlogCategoryController@blogCategoryUpdate')->name('blog.category.update');

            //Manage Blog
            Route::get('/blog/list', 'Admin\BlogController@blogList')->name('blog.list');
            Route::get('/blog/create', 'Admin\BlogController@blogCreate')->name('blog.create');
            Route::post('/blog/store/{language?}', 'Admin\BlogController@blogStore')->name('blog.store');
            Route::delete('/blog/delete/{id?}', 'Admin\BlogController@blogDelete')->name('blog.delete');
            Route::get('/blog/edit/{id?}', 'Admin\BlogController@blogEdit')->name('blog.edit');
            Route::put('/blog/update/{id?}/{language?}', 'Admin\BlogController@blogUpdate')->name('blog.update');
        });
        ...
        Route::middleware('module:shop')->group(function () {
            ...
            Route::get('/product/category/list', 'Admin\ProductCategoryController@productCategoryList')->name('product.category.list');
            Route::get('/product/category/create', 'Admin\ProductCategoryController@productCategoryCreate')->name('product.category.create');
            Route::post('/product/category/store/{language?}', 'Admin\ProductCategoryController@productCategoryStore')->name('product.category.store');
            Route::delete('/product/category/delete/{id?}', 'Admin\ProductCategoryController@productCategoryDelete')->name('product.category.delete');
            Route::get('/product/category/edit/{id?}', 'Admin\ProductCategoryController@productCategoryEdit')->name('product.category.edit');
            Route::put('/product/category/update/{id?}/{language?}', 'Admin\ProductCategoryController@productCategoryUpdate')->name('product.category.update');

            // Manage Attribute
            Route::get('/product-attribute/list', 'Admin\ProductAttributeController@productAttributeList')->name('product.attribute.list');
            Route::get('/product-attribute/create', 'Admin\ProductAttributeController@productAttributeCreate')->name('product.attribute.create');
            Route::post('/product-attribute/store', 'Admin\ProductAttributeController@productAttributeStore')->name('product.attribute.store');
            Route::delete('/product-attribute/delete/{id?}', 'Admin\ProductAttributeController@productAttributeDelete')->name('product.attribute.delete');
            Route::get('/product-attribute/edit/{id?}', 'Admin\ProductAttributeController@productAttributeEdit')->name('product.attribute.edit');
            Route::put('/product-attribute/update/{id?}', 'Admin\ProductAttributeController@productAttributeUpdate')->name('product.attribute.update');
            ...
            Route::delete('/product/image-delete/{id}/{imgDelete?}', 'Admin\ProductController@productImageDelete')->name('product.image.delete');
            ...
            Route::put('/product-stock/update/{id?}', 'Admin\ProductStockController@productStockUpdate')->name('product.stock.update');
        ...
        Route::middleware('module:book_appointment')->group(function () {
            ...
            Route::get('/book-appointment/list/{status?}', 'Admin\BookAppointmentController@appointmentList')->name('appointment.list');
            Route::get('/edit-book-appointment/{id?}', 'Admin\BookAppointmentController@editAppointment')->name('edit.appointment');
            Route::delete('/delete-book-appointment/{id?}', 'Admin\BookAppointmentController@deleteAppointment')->name('delete.appointment');
            Route::put('/book-appointment/update/{id?}', 'Admin\BookAppointmentController@updateAppointment')->name('update.appointment');
        ...
        Route::middleware('module:shop')->group(function () {
            ...
            Route::get('/product-order/product/info/{id}', 'Admin\ManageProductOrderController@orderProduct')->name('order.product.info');
            Route::post('/product-order/list/stage/change/{orderId}', 'Admin\ManageProductOrderController@stageChange')->name('stage.change.single');
            Route::get('/product-order/search', 'Admin\ManageProductOrderController@productOrderSearch')->name('product.order.search');
...
Route::middleware('module:blog')->group(function () {
    ...
    Route::get('/blog-category/{slug?}/{id}', 'FrontendController@categoryWiseBlog')->name('category.wise.blog');
    Route::get('/blog-search', 'FrontendController@blogSearch')->name('blog.search');
    Route::get('/category-wise-blog-search', 'FrontendController@categoryWiseBlogSearch')->name('category.wise.blog.search');
});
...
Route::middleware('module:shop')->group(function () {
    ...
    Route::get('/product-attributes-name', 'Frontend\ProductController@productAttributesName')->name('get.product.attributes.name');
    Route::post('/check-shopping-cart-item', 'Frontend\ProductController@checkShoppingCartItem')->name('check.shopping.cart.item');
