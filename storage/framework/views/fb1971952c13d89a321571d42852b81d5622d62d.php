        ...
        <ul class="nav nav-pills flex-column">
            <?php if(isset($settings)): ?>
                <?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="nav-item">
                        <a href="<?php echo e(getRoute($setting['route'], $setting['route_segment'] ?? null)); ?>"
                           class="nav-link <?php echo e(isMenuActive($setting['route'])); ?>">
...
<?php /**PATH C:\xampp\htdocs\barber\resources\views/admin/plugin_panel/components/sidebar.blade.php ENDPATH**/ ?>