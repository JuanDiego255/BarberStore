<div class="notification-panel" id="pushNotificationArea">
    ...
    <ul class="notification-dropdown">
        ...
        <div class="clear-all fixed-bottom">
            ...
            <a href="" class="btn-clear" v-if="items.length > 0" @click.prevent="readAll"><?php echo app('translator')->get('Clear all'); ?></a>
        </div>
    </ul>
</div>
<?php /**PATH C:\xampp\htdocs\barber\resources\views/themes/basic/partials/pushNotify.blade.php ENDPATH**/ ?>