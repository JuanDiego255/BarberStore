        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
                    <div class="card-body">
                        <div class="mb-3">
                            <h4 class="card-title mb-0">@lang('Product Information')
                            </h4>
                        </div>
                                            ...
                                            <a href="{{ route('product.details', [@slug(optional(optional($product->getProductInfo)->trashDetails)->product_name), optional($product->getProductInfo)->id]) }}"
                                                ...
                                                <div class="d-lg-flex d-block align-items-center ">
                                                    <div class="mr-3"><img
                                                            ...
                                                            height="45"></div>
                                                    <div>
                                                        <h5 class="text-secondary mb-0 font-16 font-weight-medium">
                ...
                <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
                    <div class="card-body buyer-information">
                        <div class="mb-3 d-flex justify-content-between">
                            <h4 class="card-title mb-0">@lang('Buyer Information')
                            </h4>
