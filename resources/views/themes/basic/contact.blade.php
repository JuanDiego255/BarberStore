...
@section('content')
                ...
                <div class="col-md-6" data-aos="fade-left">
                    <div class="section_left">
                        <div class="section_header">
                            ...
                            <p>@lang($contact->short_details??null)</p>
                        </div>
    ...
    <div class="address_area" data-aos="fade-down">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="email_area box">
                        ...
                        <div class="section_body">
                            ...
                            <p>@lang($contact->email_two??null)</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="location_area box">
                        <div class="section_header">
                            <h4>@lang('Barber Location')</h4>
                        </div>
                        <div class="section_body">
                            <p>
                                @lang($contact->address??null)
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="number_area box">
                        ...
                        <div class="section_body">
                            <p>@lang($contact->phone_one??null)</p>
                            <p>@lang($contact->phone_two??null)</p>
                        </div>
                    </div>
                </div>
            </div>
