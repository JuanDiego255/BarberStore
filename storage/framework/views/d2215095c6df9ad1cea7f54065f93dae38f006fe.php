                        ...
                        <div class="section_left h-100">
                            <div class="card bg-transparent border-0 rounded-0 h-100">
                                ...
                                <div class="image_area h-100">
                                    <iframe class="w-100 h-100 border-0" src="<?php echo e(@$bookAppointment->templateMedia()->map_link); ?>"
                            ...
                            <form action="<?php echo e(route('user.book.appointment')); ?>" method="post">
                                ...
                                <div class="mt-3">
                                    <input type="text" name="full_name" class="form-control"
                                        placeholder="<?php echo app('translator')->get('Full Name'); ?>" value="<?php echo e(old('full_name')); ?>" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mt-4">
                                    <input type="email" name="email" class="form-control"
                                        placeholder="<?php echo app('translator')->get('Email Address'); ?>" value="<?php echo e(old('email')); ?>" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mt-4">
                                    <input type="number" name="phone" class="form-control"
                                        placeholder="<?php echo app('translator')->get('Phone Number'); ?>" value="<?php echo e(old('phone')); ?>" autocomplete="off">
                                ...
                                <div class="mt-4">
                                    <select class="form-select form-control" name="service_name"
                                        ...
                                        <?php $__currentLoopData = $servicesName; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($data->id); ?>"><?php echo app('translator')->get(optional($data->serviceDetails)->service_name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mt-4">
                                    <textarea class="form-control" name="message" placeholder="Type Your Massage" rows="5"><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make($theme . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\barber\resources\views/themes/basic/appointment.blade.php ENDPATH**/ ?>