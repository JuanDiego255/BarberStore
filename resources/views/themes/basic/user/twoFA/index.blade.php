                    ...
                    <div class="card card-type-1 text-center br-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mx-auto text-center">
                                <img class="w-100" class="mx-auto" src="{{$previousQR}}">
                            </div>
                    ...
                    <div class="card card-type-1 text-center br-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text" id="copyBoard" onclick="copyFunction()">
                                         <i class="fa fa-copy"></i>
                                    </span>
                            </div>

                            <div class="form-group mx-auto text-center twoFa-preview-image">
                                <img class="w-25" class="mx-auto" src="{{$qrCodeUrl}}">
                            </div>

                            <div class="form-group mx-auto text-center">
                                <a href="javascript:void(0)" class="btn btn-block btn-two-factor btn-success mt-2"
                                   data-toggle="modal"
            ...
            <div class="col-lg-6 col-md-6 mb-3">
                <div class="card card-type-1 text-center">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-success btn-two-factor btn-md mt-3"
