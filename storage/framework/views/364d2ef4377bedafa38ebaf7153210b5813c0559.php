                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="tawk_id"><?php echo app('translator')->get('Tawk ID'); ?> <a href="javascript:void(0)" data-container="body" title="" data-toggle="popover" data-placement="top" data-content="embed.tawk.to/[Your Tawk code and Widget ID]" data-original-title="<?php echo app('translator')->get("How to Get it"); ?>" aria-describedby="popover392248">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group mt-2">
                                            <button type="submit" name="submit"
                                                    class="btn btn-primary btn-rounded btn-block"><?php echo app('translator')->get('Guardar changes'); ?></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\barber\resources\views/admin/plugin_panel/tawkControl.blade.php ENDPATH**/ ?>